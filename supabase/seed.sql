...
VALUES
  ('business_info', '{"name": "FlashDrop Express", "phone": "+1 647 804 9775", "email": "support@flashdropexpress.com", "domain": "flashdropexpress.com", "tagline": "Fast. Reliable. Delivered."}', 'Core company contact info'),
  ('operating_hours', '{"start": "08:00", "end": "17:00", "days": "Monday - Saturday", "after_hours_available": true}', 'Operating delivery schedule'),
  ('pricing_parameters', '{"after_hours_multiplier": 1.5, "after_hours_start": "17:00", "after_hours_end": "08:00", "waiting_rate_hourly": 25.0, "labor_rate_hourly": 30.0, "short_redirect_fee": 18.0, "hst_enabled": true, "hst_rate": 0.13}', 'Pricing rules, taxes, and fees')
