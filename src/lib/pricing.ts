...
export const DEFAULT_PRICING_TIERS: PricingTierRule[] = [
  {
    vehicleSlug: 'car',
    tierName: 'Car / Sedan (0-15 pails, up to 750 lbs)',
    maxWeightLbs: 750,
    maxPails: 15,
    rate0to25: 70,
    rate25to40: 91,
  ...
  {
    vehicleSlug: 'suv_minivan',
    tierName: 'SUV / Minivan (up to 22 pails, up to 1,100 lbs)',
    maxWeightLbs: 1100,
    maxPails: 22,
    rate0to25: 110,
    rate25to40: 125,
    rate40PlusBase: 125,
    ratePerKmOver40: 1.15,
  },
  {
    vehicleSlug: 'van',
    tierName: 'Van (up to 30 pails, up to 1,500 lbs)',
    maxWeightLbs: 1500,
    maxPails: 30,
    rate0to25: 132,
    rate25to40: 146,
  ...
  {
    vehicleSlug: 'van_suv',
    tierName: 'Van / SUV (up to 30 pails, up to 1,500 lbs)',
    maxWeightLbs: 1500,
    maxPails: 30,
    rate0to25: 132,
    rate25to40: 146,
  ...
  {
    vehicleSlug: 'truck',
    tierName: 'Box Truck (64+ pails, 3,200+ lbs)',
    maxWeightLbs: 4500,
    maxPails: 100,
    rate0to25: 268,
    rate25to40: 295,
