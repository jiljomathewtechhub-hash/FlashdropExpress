...
export const DEFAULT_BUSINESS_SETTINGS: BusinessSettings = {
  ...
  admin_notification_email: (import.meta.env.VITE_ADMIN_EMAIL as string) || 'shyswashiinc@gmail.com',
  admin_backup_email: (import.meta.env.VITE_ADMIN_BACKUP_EMAIL as string) || 'shyswashiinc@gmail.com',
